...
def define_Vgg19(opt):
    ...
    basic_model = models.vgg19(pretrained=False)
    basic_model.load_state_dict(torch.load(opt.pretrained_path))
    vgg19net = vgg19(basic_model, opt)
...
class vgg19(nn.Module):
    ...
    def deconve(self, features, original_image_width, src_level, dst_level, print_errors=True, init_feat=None):
        ...
        if init_feat is not None:
            deconvolved_feature.data = init_feat.data
